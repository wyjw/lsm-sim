#ifndef FLASH_GUARD_H
#define FLASH_GUARD_H
...
extern  uint32_t FLASH_GUARD_APP_NUMBER;
extern  size_t   FLASH_GUARD_DRAM_SIZE;
extern  size_t   FLASH_GUARD_FLASH_SIZE;
extern  uint32_t FLASH_GUARD_TH;

class flashguard : public FlashCache {
protected:
    struct Block;
